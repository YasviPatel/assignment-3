...
function fetchingTemp(select) {
  ...
  let weather = fetch(
    `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${city}?unitGroup=metric&key=9YUHX4EPRZT8SWMDXME7WWCQZ&contentType=json`
  );
  weather
    .then((response) => {
      return response.json();
    ...
    .then((data) => {
      ...
      switch (data.currentConditions.icon) {
        case "clear-day":
          temp2.innerHTML = `<img src="../icons/01d.png" height:"10px" width:"10px">`;
          break;
        case "partly-cloudy-day":
          temp2.innerHTML = `<img src="../icons/02d.png" height:"10px" width:"10px">`;
          break;
        case "cloudy":
          temp2.innerHTML = `<img src="../icons/04d.png" height:"10px" width:"10px">`;
          break;
        case "clear-night":
          temp2.innerHTML = `<img src="../icons/01n.png" height:"10px" width:"10px">`;
          break;
        default:
          temp2.innerHTML = `<img src="../icons/unknown.png" height:"10px" width:"10px">`;
          break;
      }
    });
}
